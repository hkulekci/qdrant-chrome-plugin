...
type TabName = 'overview' | 'collections' | 'shards' | 'optimizations' | 'transfers' | 'cluster' | 'requests' | 'insights' | 'upgrade' | 'explorer';
...
const BASE_TABS: { key: TabName; label: string }[] = [
  ...
  { key: 'explorer', label: 'Vector Explorer' },
    ...
    <div className="container">
      ...
      {data && (
        <>
          ...
          {activeTab === 'explorer' && <VectorExplorerTab data={data} cluster={cluster} />}
